...
const privateLinks: NavbarItem[] = [
    ...
    { link: "/calendar", label: "Calendar", icon: IconCalendar, onClick: undefined },
    { link: "/profile", label: "Profile", icon: IconUser, onClick: undefined }
]

const publicLinks: NavbarItem[] = [
    { link: "/", label: "Home", icon: IconHome2, onClick: undefined },
    { link: "/about", label: "About", icon: IconInfoCircle, onClick: undefined }
]
...
export const Navbar = () => {
    ...
    const logInOut = (userAuth && authStatus !== AuthStatus.NoUser) ?
        { link: "/", label: "Log out", icon: IconLogout, onClick: logout } :
        { link: "/login", label: "Log in", icon: IconLogin, onClick: undefined }

    const data = (userAuth && authStatus !== AuthStatus.NoUser) ? privateLinks : publicLinks
